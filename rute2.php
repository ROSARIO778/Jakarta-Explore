                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div id="results" class="mt-4" style="display: none;">
                                ...
                                <p><strong>Jarak Tempuh:</strong> <span id="resultDistance">Sedang menghitung...</span></p>
                                <p><strong>Estimasi Waktu:</strong> <span id="resultTime">Sedang menghitung...</span></p>
                                <p><strong>Status Rute:</strong> <span id="routeStatus">Menunggu hasil...</span></p>
                                <p><strong>Nama Rute:</strong> <span id="routeName"></span></p>
